//
//  YZMRangeSliderView.h
//
//  Created by Tom Thorpe
//

#import <UIKit/UIKit.h>
#import "YZMRangeSliderDelegate.h"

IB_DESIGNABLE
@interface YZMRangeSlider : UIControl <UIGestureRecognizerDelegate>

@property (nonatomic, weak) IBOutlet id<YZMRangeSliderDelegate> delegate;
 ...
 * You can override this default here by supplying your own NSNumberFormaYZMer. For example, you could supply an NSNumberFormaYZMer that has a currency style, or a prefix or suffix.
