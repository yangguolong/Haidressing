...
- (void)commonInit {
    ...
    tagInputField_.layer.cornerRadius = 4;
    ...
    tagInputField_.font = [UIFont fontWithName:@"HelveticaNeue" size:12];
...
- (void)layoutSubviews {
    ...
    for (UIView *view in tagSubviews_) {
        ...
        if (index != 0) {
            ...
            tempViewFrame.origin.x = prevView.frame.origin.x - tempViewFrame.size.width - 4;
        } else {
            tempViewFrame.origin.x = self.frame.size.width - tempViewFrame.size.width - 1;
        }
...
- (void)reloadTagSubviews {
    ...
    for (NSString *tag in _tags) {
        ...
        tagView.layer.borderColor = tagTextColor.CGColor;
...
//        tagLabel.layer.cornerRadius = 3;
        ...
        if (_mode == TLTagsControlModeEdit) {
            ...
            tagFrame.size.width = labelFrame.size.width + 4;
            labelFrame.origin.x = (tagFrame.size.width - labelFrame.size.width) / 2 ;
        }
