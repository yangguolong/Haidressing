...
static NSString *kNSDateHelperFormatRequestTime         = @"yyMMddHHmmss";
...
+ (NSString *)stringWithTimeInterval:(NSTimeInterval)secs
{
    ...
    NSString *outputString = [dateFormatter stringFromDate:confromTimesp];
    return outputString;
}
