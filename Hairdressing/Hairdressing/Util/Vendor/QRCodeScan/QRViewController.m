...
{
    if (_alertView == nil) {
        _alertView = [[UILabel alloc] initWithFrame:CGRectMake(0, self.view.frame.size.height / 2 +125, self.view.frame.size.width, 45)];
        _alertView.text = @"将二维码放入框内，即可自动扫描";
        [_alertView setTextAlignment:NSTextAlignmentCenter];
        [_alertView setTextColor:[UIColor whiteColor]];
